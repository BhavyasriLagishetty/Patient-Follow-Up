...
<html lang="en">
    ...
    <body>
        <div id="body-bg">
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="dviewpatient.jsp" class="fa-comment active">View Patient</a>
                                       
                                    </li>
                                    <li>
                                        <a href="dviewp.jsp" class="fa-comment ">View Patient Questionnaire</a>
          ...
          <center>
          <br>
                    <h1><font color="black">View Patient's</font></h1>                    
                    <br>
