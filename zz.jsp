					...
					<div class="col-md-8 no-padding">
						<div class="visible-lg">
							<ul id="hornavmenu" class="nav navbar-nav">
								<li><a href="pharmacisthome.jsp" class="fa-comment">Home</a>
								</li>
								<li><a href="pharmaViewPatients.jsp" class="fa-comment">View
										Patients</a></li>
								<li><a href="Gopal_QQ.jsp" class="fa-home active">Questionnaire</a>
		...
		<div id="content" class="bottom-border-shadow">
			<div class="container background-white bottom-border">
				<center>
					<br>
					<h1>
						<font color="black">Welcome <%=user%></font>
					</h1>
					<br>
					<center>
						<form name="myform" action="FileUploadServlet" method="post"
							...
							<table border="0">
								...
								<tr>
									<th><b>Select All files</b></th>
									<td>:</td>
									<td><input type="file" placeholder="select" id="files"
										name="files" required="required" multiple></td>
								</tr>
