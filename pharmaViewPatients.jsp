					...
					<div class="col-md-8 no-padding">
						<div class="visible-lg">
							<ul id="hornavmenu" class="nav navbar-nav">
								...
								<li><a href="pharmaViewPatients.jsp"
									class="fa-comment active">View Patients</a></li>
		...
		<div id="content" class="bottom-border-shadow">
			<div class="container background-white bottom-border">
				<center>
					<br>
					<h1>
						<font color="black">View Patients</font>
					</h1>
					<br>
					...
					<table align="center" border="2">
						<tr>
							<th><a href="patientreg.jsp">Add Patient</a></th>
						</tr>
					</table>
					<!-- <table align="center" border="2">
						<tr>
							<th><a href="pharmacistreg.jsp">Add Patient</a></th>
						</tr>
					</table> -->
				</center>
				<br> <br>
