...
<body>
	<strong><font size="3" color="black">
			<div id="body-bg">
								...
								<div class="visible-lg">
									<ul id="hornavmenu" class="nav navbar-nav">
										...
										<li>
											...
											<a href="Gopal_QQ.jsp" class="fa-comment active">Questionnaire</a>
				...
				<center>
					...
					<br> <strong><font size="3" color="black">Question
							Type</font></strong> <select name="feetype" onChange="playVideo(this)">
					...
					<div id='Description' style='display: none'>
						...
						<br>
						<form action="FileUploadServlet2" method="post"
							...
							<table align="center">
								<tr>
									...
									<td><input type="submit" value="Schedule"
										style="height: 30px; width: 70px" /> <input type="reset"
										value="Reset" style="height: 30px; width: 50px" /></td>
									<br>
							</table>
				</center>
				<br>
	...
	<div id='Objective' style='display: none'>
		...
		<form action="FileUploadServlet1" method="post"
			enctype="multipart/form-data">
